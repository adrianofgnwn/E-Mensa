    ...
    <main>
        ...
        <table>
            <tr>
                ...
                <th>Preis extern</th>
                <th>ALLERGENS</th>
                <th>Bewertung abgeben</th>
            </tr>
            @foreach($dishes as $dish)
                <tr>
                    <td>
                        @if(!empty($dish['image']))
                            <img src="{{ $dish['image'] }}" alt="{{ $dish['name'] }}" style="width:120px;"><br>
                        @endif
                        {{ $dish['name'] }}
                    </td>
                    ...
                    <td>
                        <a href="/bewertung?gerichtid={{ $dish['id'] }}" class="btn btn-primary">Bewertung abgeben</a>
                    </td>
                </tr>
            @endforeach
        </table>
